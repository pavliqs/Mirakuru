...
"padding-left: 5px;"))
        ...
        self.eraseRButton = QtGui.QPushButton(self.layoutWidget)
        self.eraseRButton.setMinimumSize(QtCore.QSize(24, 24))
        self.eraseRButton.setMaximumSize(QtCore.QSize(24, 24))
        self.eraseRButton.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/assets/erase.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.eraseRButton.setIcon(icon2)
        self.eraseRButton.setIconSize(QtCore.QSize(18, 18))
        self.eraseRButton.setObjectName(_fromUtf8("eraseRButton"))
...
"padding-left: 5px;"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/assets/add_windows_template.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pluginTemplateInsesrtButton.setIcon(icon3)
        self.pluginTemplateInsesrtButton.setIconSize(QtCore.QSize(18, 18))
        self.pluginTemplateInsesrtButton.setObjectName(_fromUtf8("pluginTemplateInsesrtButton"))
        self.horizontalLayout_4.addWidget(self.pluginTemplateInsesrtButton)
        self.eraseLButton = QtGui.QPushButton(self.layoutWidget1)
        self.eraseLButton.setMinimumSize(QtCore.QSize(24, 24))
        self.eraseLButton.setMaximumSize(QtCore.QSize(24, 24))
        self.eraseLButton.setText(_fromUtf8(""))
        self.eraseLButton.setIcon(icon2)
        self.eraseLButton.setIconSize(QtCore.QSize(18, 18))
        self.eraseLButton.setObjectName(_fromUtf8("eraseLButton"))
        self.horizontalLayout_4.addWidget(self.eraseLButton)
...
"            }"))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/assets/execute.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 5px;"))
        ...
        self.statusConsoleText.setGeometry(QtCore.QRect(9, 9, 256, 192))
...
"            }"))
        ...
        self.gridLayout_7.addWidget(self.splitter_3, 4, 0, 1, 2)
